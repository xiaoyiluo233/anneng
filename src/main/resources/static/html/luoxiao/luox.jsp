...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="css/luoxcss/luox.css" />
		...
		<link href="css/luoxcss/city-picker.css" rel="stylesheet" type="text/css" />
	</head>
	<style>
		
	</style>
	<script type="text/javascript" src="js/luoxjs/jquery-3.4.1.min.js"></script>
	<script type="text/javascript" src="js/luoxjs/jquery.easyui.min.js"></script>
	<script type="text/javascript" src="easyui/jquery-1.7.2.min.js"></script>
	<script type="text/javascript" src="easyui/jquery.easyui.min.js"></script>
	<script src="js/luoxjs/jquery.js"></script>
	<script src="js/luoxjs/bootstrap.js"></script>
	<script src="js/luoxjs/city-picker.data.js"></script>
	<script src="js/luoxjs/city-picker.js"></script>
	<script src="js/luoxjs/main.js"></script>
	...
	<body style="background-color: #dfe0e1;">
		...
		<center>
			...
			-->
			<div id="head">
				<img id="log" src="img/luoxImg/logowhite.png" />
				<div id="hean-message">
					<h5>本间芽衣子 </h5>
					<img src="img/luoxImg/huhu.gif">
				</div>
			</div>
			<!--
				中间一块整体
			...
			<div id="center">
				<div id="function">
					<div id="head_portrait">
						<img id="touxk" src="img/luoxImg/imgBg.png" />
						<img id="head_portraits" src="img/luoxImg/huhu.gif" />
						<h2>本间芽衣子</h2>
					</div>
					<div id="icon">
						<a class="branch">
							<img src="img/luoxImg/chachao.png" />
							<h5>我要查件</h5>
						</a>
						<a class="branch">
							<img src="img/luoxImg/xiangzi.png" />
							<h5>我要寄件 </h5>
						</a>
						<a id="myjijian" class="branch">
							<img src="img/luoxImg/jijian.png" />
							<h5>我的寄件 </h5>
						</a>
						<a class="branch">
							<img src="img/luoxImg/shoujian.png" />
							<h5>我的收件 </h5>
						</a>
						<a class="branch">
							<img src="img/luoxImg/dizhi.png" />
							<h5>地址薄 </h5>
						</a>
						<a id="myziliao" class="branch">
							<img src="img/luoxImg/touxiang.png" />
							<h5>我的资料 </h5>
						</a>
						<a class="branch">
							<img src="img/luoxImg/yinghangka.png" />
							<h5>我的银行卡 </h5>
						</a>
						<a class="branch">
							<img src="img/luoxImg/mima.png" />
							<h5>修改密码 </h5>
						</a>
					</div>
				</div>
				...
				<div  id="kong">
					...
					<div style="width: 760px; height: 40px; margin: 20px; border: solid 1px #cccccc;border-top: none; border-left: none; border-right: none;">
						<img src="img/luoxImg/dingdan.png" style="width: 20px;height: 20px;float: left;" />
						<span style="float: left;"> 订单号: </span>
						</div>
						<div style=" float: left;margin-left: 20px;">
							<img src="img/luoxImg/ji.png" />
							<span style="font-size: 20px;font-weight: bold;"> 长沙市 刘佳佳</span>
							<br />
							<span >下单时间</span>
						</div>
						<div style=" float: left;margin-left: 250px;">
							<img src="img/luoxImg/pai.png"/>
				...
				<img style="margin-right: 70px;" src="img/luoxImg/foot-01.png" />

				<span class="tail2"><img src="img/luoxImg/foot-02.png"/>沪公网安备 31011802001067号</span>
				<span class="tail3"><img src="img/luoxImg/foot-03.png"/ >上海工商</span>
